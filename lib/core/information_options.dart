/// Complete, user-facing information choices backed by the bundled offline
/// library. Keep this catalog in sync with the Android reference generator.
class InformationOptions {
  InformationOptions._();

  static const List<String> delays = <String>[
    '0 · keine',
    '005.wav · ca. 5 min',
    '010.wav · ca. 10 min',
    '015.wav · ca. 15 min',
