...
final class InTrainSequenceSupport {
    ...
    static String idForLabel(String label) {
        ...
        if ("Dieser Zug endet dort".equals(label)) return "train_ends";
        if ("Fahrgäste bitte alle aussteigen".equals(label)) return "all_exit";
        ...
        if ("Hinweis · Höhenunterschied zur Bahnsteigkante".equals(label)) return "platform_gap";
        return null;
    }
    ...
    static String labelForId(String id) {
        ...
        if ("train_ends".equals(id)) return "Dieser Zug endet dort";
        if ("all_exit".equals(id)) return "Fahrgäste bitte alle aussteigen";
        ...
        if ("platform_gap".equals(id)) return "Hinweis · Höhenunterschied zur Bahnsteigkante";
    ...
    static ArrayList<String> toAssetPlaylist(List<String> sequence, String stationClip) {
        ...
        for (String block : sequence) {
            ...
            } else if ("train_ends".equals(block)) output.add("asset:/inzug/text/dieser_zug_endet_dort.opus");
            else if ("all_exit".equals(block)) output.add("asset:/inzug/text/fahrgaeste_bitte_alle_aussteigen.opus");
            ...
            else if ("platform_gap".equals(block)) output.add("asset:/inzug/text/hinweis_bahnsteigkante.opus");
